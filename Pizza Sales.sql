...
The number of a table is same in the table  in the CSV file 
*/
...
-- Use LOAD DATA INFILE to transfer data from CSV from to MYSQL
...
/* 
Then proceed to the important code that can use to the KPI's
